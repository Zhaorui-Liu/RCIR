...
def main():
    ...
    for i, ref_img in enumerate(loader):
        ...
        torch.save({
            ...
            'normal': getattr(operator, 'normal_map', None),
        ...
        if hasattr(operator, 'normal_map'):
            imwrite(operator.normal_map.detach().cpu(),os.path.join(out_path, 'material','normal', str(i).zfill(5) + '.exr'),gamma=1)
